...
describe('LowLevelTokenizer', function()
{
  ...
  describe('#transform()', function()
  {
    ...
    it('literal open bracket', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.Text, "<", 0, 1);
      assertDone(tokenizer);
    });
    it('literal open brackets with text', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.Text, "<", 0, 5);
      assertToken(tokenizer, LowLevelTokenType.Text, "Text", 0, 6);
      assertToken(tokenizer, LowLevelTokenType.Text, "<", 0, 11);
      assertToken(tokenizer, LowLevelTokenType.Text, "<", 0, 13);
      assertToken(tokenizer, LowLevelTokenType.Text, "Text", 0, 14);
      assertToken(tokenizer, LowLevelTokenType.Text, "<", 0, 19);
    ...
    it('start tag', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "tag", 0, 1);
      assertDone(tokenizer);
    });
    ...
    it('less than sign with newline', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.Text, "<", 0, 0);
      assertToken(tokenizer, LowLevelTokenType.NewLine, "\n", 0, 1);
      assertToken(tokenizer, LowLevelTokenType.Text, "tag>", 1, 0);
      assertDone(tokenizer);
    });
    ...
    it('end tag', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.CloseTag, "tag", 0, 2);
      assertDone(tokenizer);
    });
    ...
    it('identifiers are legal tag names', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "tag_2", 0, 1);
    ...
    it('identifiers are legal attribute keys', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.AttributeValue, "", 0, 12);
      assertToken(tokenizer, LowLevelTokenType.Text, "Text", 0, 15);
      assertDone(tokenizer);
    });
    ...
    it('attribute with value without end bracket', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.AttributeValue, "value", 0, 10);
      assertToken(tokenizer, LowLevelTokenType.Error, "Unexpected end of input in tag.", 0, 17);
    ...
    it('start tag with attribute and spaces', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "tag", 0, 1);
      assertToken(tokenizer, LowLevelTokenType.AttributeKey, "attr", 0, 8);
      assertToken(tokenizer, LowLevelTokenType.AttributeValue, "value", 0, 19);
      assertDone(tokenizer);
    });
    it('start tag with attribute and tabs', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "tag", 0, 1);
      assertToken(tokenizer, LowLevelTokenType.AttributeKey, "attr", 0, 7);
      assertToken(tokenizer, LowLevelTokenType.AttributeValue, "value", 0, 18);
      assertDone(tokenizer);
    });
    it('start tag with attribute and newlines', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "tag", 0, 1);
      assertToken(tokenizer, LowLevelTokenType.AttributeKey, "attr", 3, 0);
      assertToken(tokenizer, LowLevelTokenType.AttributeValue, "value", 9, 1);
      assertDone(tokenizer);
    });
    ...
    it('two attributes without values with text', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.AttributeKey, "attr", 0, 5);
      assertToken(tokenizer, LowLevelTokenType.Error, "attribute does not have a value.", 0, 10);
      assertToken(tokenizer, LowLevelTokenType.Text, "Text", 0, 16);
      assertToken(tokenizer, LowLevelTokenType.CloseTag, "tag", 0, 22);
      assertDone(tokenizer);
    });
    ...
    it('attribute with value without quotes', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "tag", 0, 1);
      assertToken(tokenizer, LowLevelTokenType.AttributeKey, "attr", 0, 5);
      assertToken(tokenizer, LowLevelTokenType.Error, "Attribute values must be surrounded by double-quotes.", 0, 10);
      assertDone(tokenizer);
    });
    ...
    it('attribute with equals but not value', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.AttributeKey, "attr", 0, 5);
      assertToken(tokenizer, LowLevelTokenType.Error, "attribute does not have a value.", 0, 10);
      assertToken(tokenizer, LowLevelTokenType.Text, "Text", 0, 11);
      assertDone(tokenizer);
    });
    it('attribute without value and text and end tag', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.CloseTag, "tag", 0, 16);
      assertDone(tokenizer);
    });
    ...
    it('tag with empty attribute', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "tag", 0, 1);
      assertToken(tokenizer, LowLevelTokenType.AttributeKey, "attr", 0, 5);
      assertToken(tokenizer, LowLevelTokenType.AttributeValue, "", 0, 10);
      assertDone(tokenizer);
    });
    it('tag with two attributes', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.AttributeKey, "attr", 0, 5);
      assertToken(tokenizer, LowLevelTokenType.AttributeValue, "value", 0, 10);
      assertToken(tokenizer, LowLevelTokenType.AttributeKey, "attr2", 0, 18);
      assertToken(tokenizer, LowLevelTokenType.AttributeValue, "value2", 0, 24);
      assertDone(tokenizer);
    });
    it('open and close tag', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "tag", 0, 1);
      assertToken(tokenizer, LowLevelTokenType.CloseTag, "tag", 0, 7);
      assertDone(tokenizer);
    });
    it('nested open and close tags', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "tag", 0, 1);
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "i", 0, 6);
      assertToken(tokenizer, LowLevelTokenType.CloseTag, "i", 0, 10);
    ...
    it('open with attributes and close tag with text', function()
    {
      ...
      assertToken(tokenizer, LowLevelTokenType.AttributeKey, "attr", 0, 5);
      assertToken(tokenizer, LowLevelTokenType.AttributeValue, "value", 0, 10);
      assertToken(tokenizer, LowLevelTokenType.Text, "Text", 0, 18);
      assertToken(tokenizer, LowLevelTokenType.CloseTag, "tag", 0, 24);
      assertDone(tokenizer);
    });
...
<tag attr=\"value\" attr2=\"value2\"><i>B</i></tag>`);
      ...
      assertToken(tokenizer, LowLevelTokenType.NewLine, "\n", 0, 0);
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "tag", 1, 1);
      assertToken(tokenizer, LowLevelTokenType.AttributeKey, "attr", 1, 5);
      assertToken(tokenizer, LowLevelTokenType.AttributeValue, "value", 1, 10);
      assertToken(tokenizer, LowLevelTokenType.AttributeKey, "attr2", 1, 18);
      assertToken(tokenizer, LowLevelTokenType.AttributeValue, "value2", 1, 24);
      assertToken(tokenizer, LowLevelTokenType.Text, "A", 1, 33);
      ...
      assertToken(tokenizer, LowLevelTokenType.NewLine, "\n", 2, 21);
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "tag", 3, 1);
      assertToken(tokenizer, LowLevelTokenType.AttributeKey, "attr", 3, 5);
      assertToken(tokenizer, LowLevelTokenType.AttributeValue, "value", 3, 10);
      assertToken(tokenizer, LowLevelTokenType.AttributeKey, "attr2", 3, 18);
      assertToken(tokenizer, LowLevelTokenType.AttributeValue, "value2", 3, 24);
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "i", 3, 34);
      assertToken(tokenizer, LowLevelTokenType.Text, "B", 3, 36);
...
`);
      ...
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "tag", 2, 3);
      assertToken(tokenizer, LowLevelTokenType.NewLine, "\n", 2, 7);
      assertToken(tokenizer, LowLevelTokenType.Text, "    ", 3, 0);
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "tag", 3, 5);
      assertToken(tokenizer, LowLevelTokenType.NewLine, "\n", 3, 9);
      assertToken(tokenizer, LowLevelTokenType.Text, "      This is a ", 4, 0);
      assertToken(tokenizer, LowLevelTokenType.OpenTag, "i", 4, 17);
      assertToken(tokenizer, LowLevelTokenType.Text, "lot", 4, 19);
      assertToken(tokenizer, LowLevelTokenType.CloseTag, "i", 4, 24);
      assertToken(tokenizer, LowLevelTokenType.Text, " of text", 4, 26);
      assertToken(tokenizer, LowLevelTokenType.NewLine, "\n", 4, 34);
      assertToken(tokenizer, LowLevelTokenType.Text, "    ", 5, 0);
      assertToken(tokenizer, LowLevelTokenType.CloseTag, "tag", 5, 6);
      assertToken(tokenizer, LowLevelTokenType.NewLine, "\n", 5, 10);
      assertToken(tokenizer, LowLevelTokenType.Text, "  ", 6, 0);
      assertToken(tokenizer, LowLevelTokenType.CloseTag, "tag", 6, 4);
      assertToken(tokenizer, LowLevelTokenType.NewLine, "\n", 6, 8);
      assertToken(tokenizer, LowLevelTokenType.CloseTag, "tag", 7, 2);
      assertToken(tokenizer, LowLevelTokenType.NewLine, "\n", 7, 6);
      assertToken(tokenizer, LowLevelTokenType.NewLine, "\n", 8, 0);
      assertDone(tokenizer);
    })
